...
function App(): JSX.Element {
  ...
  const [trophyData,setTrophyData] = useState([
    ...
    {title:"Yoga Yogi",progressQTY:1, imgPath:require('./IconBin/TrophyPNG/simple1.png'), tier:"Gold", desc:"Log 500 at home yoga posts.",},
    ...
    {title:"Web3 Wizard",progressQTY:10, imgPath:require('./IconBin/TrophyPNG/simple4.png'), tier:"Bronze", desc:"Purchase & Hold an NFT. Log your 1/1 claim.",},
    ...
    {title:"Cant Stop Wont Stop",progressQTY:24,imgPath:require('./IconBin/TrophyPNG/gem5.png'),tier:"Bronze",desc:"Play a single game for 24 hours straight and post it."},
    ...
    {title:"Social Butterfly",progressQTY:150, imgPath:require('./IconBin/TrophyPNG/mirror2.png'), tier:"Silver", desc:"Attend & Log in at 200 different social events or meetups. Family and/or Friends",},
    {title:"All Abord",progressQTY:1000,imgPath:require('./IconBin/TrophyPNG/steering1.png'),tier:"Silver",desc:"Organize & Log a family or friends road trip with at least 3 other people. Make it huge!"},
    ...
    {title:"Hands of Bronze",progressQTY:100, imgPath:require('./IconBin/TrophyPNG/gem7.png'), tier:"Bronze", desc:"Volunteer & log for 100+ hours in community service.",},
    ...
    {title:"Lost in Nature",progressQTY:15,imgPath:require('./IconBin/TrophyPNG/goblet3.png'),tier:"Bronze",desc:"Log 50 outdoor experiences."},
    {title:"Finding Nature",progressQTY:100,imgPath:require('./IconBin/TrophyPNG/star9.png'),tier:"Silver",desc:"Log 200 outdoor experiences."},
    {title:"One with Nature",progressQTY:500,imgPath:require('./IconBin/TrophyPNG/star10.png'),tier:"Gold",desc:"Log 1,000 outdoor experiences"},
    ...
    {title:"Nature's Friend",progressQTY:25, imgPath:require('./IconBin/TrophyPNG/person2.png'), tier:"Bronze", desc:"Plant & Log 100 unique trees of any shape or size.",},
    {title:"Nature's Steward",progressQTY:100, imgPath:require('./IconBin/TrophyPNG/person3.png'), tier:"Silver", desc:"Volunteer & Log 25 different community cleanups.",},
