...
function AppMain(): JSX.Element {
  ...
  const [XPTriggerEvents,setXPTriggerEvents] = useState({
    ...
    technology: {
      ...
      build_3d_model: {type:"camera",title:"3D Model",desc:"Show off a 3D model you made.",xp : 3, unlocksAt: 2, perDay: 2, perWeek: 0, perMonth: 0},
      drone: {type:"camera",title:"Drone Pilot",desc:"Pilot one or many drones.",xp : 20, unlocksAt: 3, perDay: 1, perWeek: 0, perMonth: 0},
      commit_open_src: {type:"api",title:"Open Source",desc:"Commit code to a public github repository.", xp: 2, unlocksAt: 5, perDay: 10, perWeek: 0, perMonth:0 },
