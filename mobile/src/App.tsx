...
function App(): JSX.Element {
  ...
  const [XPTriggerEvents,setXPTriggerEvents] = useState({
    ...
    cooking: {
      ...
      bake: {type:"camera",title:"Bake Something",desc:"Bake anything & label what it is.", xp: 5, unlocksAt: 0, perDay: 2, perWeek: 0, perMonth:0 },
      try_new_recipe: {type:"camera",title:"Unique Recipe",desc:"Document unique recipe than any you previously have.", xp: 20, unlocksAt: 10, perDay: 1, perWeek: 0, perMonth:0 },
      ...
      host_dinner: {type:"camera",title:"Host a Dinner Party",desc:"Host a dinner party for yourself and 4 other family or friends!", xp: 50, unlocksAt: 30, perDay: 0, perWeek: 1, perMonth:0 },
      random_month_challenge: {type:"timeline",title:"Monthly Challenge",desc:"Complete the monthly challenge.", xp: 150, unlocksAt: 40, perDay: 0, perWeek: 0, perMonth:1 },
      cooking_class: {type:"timeline",title:"Cooking Class",desc:"Host or attend a cooking class.", xp: 200, unlocksAt: 50, perDay: 0, perWeek: 0, perMonth:1 }
    },
    technology: {
    ...
    games: {
      play_board_game: {type:"camera",title:"Tabletop Game",desc:"Play a board or card game with at least 2 other people.", xp: 5, unlocksAt: 0, perDay: 2, perWeek: 0, perMonth:0 },
      ...
      sports_practice: { type:"camera",title:"Practice?",desc:"Train in anything that can be considered a physical sport.",xp: 5, unlocksAt: 0, perDay: 1, perWeek: 0, perMonth:0 },
      sports_match: {type:"timeline",title:"Sports Match",desc:"Compete in anything that can be considered a physical sport. Must be at least one other contestant.", xp: 20, unlocksAt: 10, perDay: 0, perWeek: 3, perMonth:0 },
      game_achievement: {type:"api",title:"Video Game Achievement",desc:"Unlock a Steam achievement.", xp: 20, unlocksAt: 20, perDay: 1, perWeek: 0, perMonth:0 },
      stream_time: {type:"api",title:"Stream Time",desc:"Steam yourself gaming! Must connect steaming platform account.", xp: 5, unlocksAt: 25, perDay: 10, perWeek: 0, perMonth:0 },
      tabletop_rpg: {type:"timeline",title:"Play a TTRPG",desc:"Play a tabletop roleplaying game like D&D, either in person or online.", xp: 30, unlocksAt: 30, perDay: 0, perWeek: 1, perMonth:0 },
      tournament: {type:"timeline",title:"Tournament",desc:"Host a gaming or sporting tournament of any kind with 8 participants.", xp: 50, unlocksAt: 50, perDay: 0, perWeek: 1, perMonth:0 },
      live_event: {type:"timeline",title:"Live Sports Event",desc:"Attend a sporting competition in real life. Must take picture of crowd.", xp: 250, unlocksAt: 40, perDay: 0, perWeek: 0, perMonth:1 },
  ...
  const [trophyData,setTrophyData] = useState([
    {title:"Titan of Steel",progressQTY:21,imgPath:require('./IconBin/TrophyPNG/goblet1.png'),tier:"Bronze",desc:"Log gym attendence for 21 days straight without missing a single day.",unlocked:false},
    {title:"Uphill Battle",progressQTY:100,imgPath:require('./IconBin/TrophyPNG/gem1.png'),tier:"Silver",desc:"Log gym attendence for at least 100 days out of the year. Counter starts Jan 1.",unlocked:false},
    {title:"Progress of Pain",progressQTY:200,imgPath:require('./IconBin/TrophyPNG/number1.png'),tier:"Gold",desc:"Log gym attendence for at least 200 days of the year. Counter starts and ends Jan 1.",unlocked:false},
    {title:"Sisyphus' Prized Work",progressQTY:1000,imgPath:require('./IconBin/TrophyPNG/pedistal1.png'),tier:"Gold",desc:"Log 1,000 gym posts on ARL",unlocked:false},
    {title:"Marathon's March",progressQTY:1000, imgPath:require('./IconBin/TrophyPNG/gem2.png'), tier:"Silver", desc:"Run or walk & Log a total of 1,000 miles tracked on ARL.", unlocked:false},
    {title:"Martial Master",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/elegant2.png'),tier:"Gold",desc:"Place top 3 in a large martial arts contest. Log yourself with your trophy.",unlocked:false},
    {title:"26.2",progressQTY:1, imgPath:require('./IconBin/TrophyPNG/gem3.png'), tier:"Gold", desc:"Run and complete a Marathon. Log yourself at the finish line.", unlocked:false},
    {title:"Grounded Discipline",progressQTY:1, imgPath:require('./IconBin/TrophyPNG/simple1.png'), tier:"Gold", desc:"Log 1,0000 at home yoga posts.", unlocked:false},
    ...
    {title:"Resolution Revolution II",progressQTY:365,imgPath:require('./IconBin/TrophyPNG/star3.png'),tier:"Silver",desc:"Cook & Log 365 total meals.",unlocked:false},
    {title:'Cooking Connoisseur',progressQTY:1000,imgPath:require('./IconBin/TrophyPNG/simple3.png'),tier:"Gold",desc:"Cook & Log 1,000 total meals.",unlocked:false},
    {title:"Recipe Repeater",progressQTY:25,imgPath:require('./IconBin/TrophyPNG/shield1.png'),tier:"Silver",desc:"Cook & Log 25 different weekly challenge recipes.",unlocked:false},
    {title:"Family Feast",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/star2.png'),tier:"Bronze",desc:"Cook & Log a holiday dinner with at least 6 family members in attendance.",unlocked:false},

    {title:"Clean Your Keyboard",progressQTY:1000,imgPath:require('./IconBin/TrophyPNG/elegant3.png'),tier:"Gold",desc:"Make & Log 1000 contributions to Github tracked through ARL.",unlocked:false},
    {title:"Bearing FAANGs",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/star4.png'),tier:"Silver",desc:"Make & Log an app for the iOS and Google Play store.",unlocked:false},
    {title:"Internet Property",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/person4.png'),tier:"Bronze",desc:"Create and host your own domain name server. Log the link (HTTPS required).",unlocked:false},
    {title:"Digital Playground",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/gear.png'),tier:"Silver",desc:"Develop & release your own game onto Steam, The Web, or both App Stores. Log the link.",unlocked:false},
    {title:"Web3 Wizard",progressQTY:10, imgPath:require('./IconBin/TrophyPNG/simple4.png'), tier:"Bronze", desc:"Purchase & Hold an NFT. Log your 1/1 claim.", unlocked:false},

    {title:"Gamer with Taste",progressQTY:50,imgPath:require('./IconBin/TrophyPNG/simple5.png'),tier:"Silver",desc:"Play 50 different Steam games for 10 hours each.",unlocked:false},
    ...
    {title:"The Grind",progressQTY:1000,imgPath:require('./IconBin/TrophyPNG/gem4.png'),tier:"Silver",desc:"Play & Log 1,000 hours in Steam one year. Counter starts Jan 1",unlocked:false},
    {title:"Gotta Go Fast",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/number2.png'),tier:"Gold",desc:'Prove by posting that you own the world record speedrun in any video game.',unlocked:false},
    {title:"Cant Stop Wont Stop",progressQTY:24,imgPath:require('./IconBin/TrophyPNG/gem5.png'),tier:"Bronze",desc:"Play a single game for 24 hours straight and post it.",unlocked:false},

    {title:"Lightfoot Traveler",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/elegant4.png'),tier:"Bronze",desc:"Visit & Log any foreign country.",unlocked:false},
    {title:"Globe Trotter",progressQTY:10, imgPath:require('./IconBin/TrophyPNG/simple6.png'), tier:"Gold", desc:"Visit & Log 10 different countries.", unlocked:false},
    {title:"Artistic Soul",progressQTY:20, imgPath:require('./IconBin/TrophyPNG/gem6.png'), tier:"Bronze", desc:"Visit & Log in at 20 different art museums and galleries.", unlocked:false},
    {title:"Social Butterfly",progressQTY:150, imgPath:require('./IconBin/TrophyPNG/mirror2.png'), tier:"Silver", desc:"Attend & Log in at 200 different social events or meetups. Family and/or Friends", unlocked:false},
    {title:"All Abord",progressQTY:1000,imgPath:require('./IconBin/TrophyPNG/steering1.png'),tier:"Silver",desc:"Organize & Log a family or friends road trip with at least 3 other people. Make it huge!",unlocked:false},

    {title:"Family Reunion",progressQTY:1, imgPath:require('./IconBin/TrophyPNG/star5.png'), tier:"Gold", desc:"Organize & Log a family reunion with at least 15 family members.", unlocked:false},
    {title:"Checking In",progressQTY:100, imgPath:require('./IconBin/TrophyPNG/pedistal2.png'), tier:"Bronze", desc:"Log 100 calls to close friends or loved ones.", unlocked:false},
    {title:"Game of Life",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/simple3.png'),tier:"Bronze",desc:"Log a family game night with 3 generations present.",unlocked:false},
    {title:"Clean Leader",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/star6.png'),tier:"Bronze",desc:"Organize & Log a family cleanup of the entire house.",unlocked:false},

    {title:"Hands of Bronze",progressQTY:100, imgPath:require('./IconBin/TrophyPNG/gem7.png'), tier:"Bronze", desc:"Volunteer & log for 100+ hours in community service.", unlocked:false},
    {title:"Eyes of Silver",progressQTY:50, imgPath:require('./IconBin/TrophyPNG/star7.png'), tier:"Silver", desc:"Create & Log 50 physical pieces of art that you have created.", unlocked:false},
    {title:"Voice of Gold",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/person1.png'),tier:"Gold",desc:"Log your acting in a play or performance of any kind, on a stage in front of an audience.",unlocked:false},
    {title:"Decoration of Space",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/gem8.png'),tier:"Silver",desc:"Display & Log a piece of physical art at a public art gallery.",unlocked:false},
    {title:"Decoration of Time",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/star8.png'),tier:"Bronze",desc:"Link & Log an album of at least 12 songs that you created into Soundcloud",unlocked:false},

    {title:"Lost in Nature",progressQTY:15,imgPath:require('./IconBin/TrophyPNG/goblet3.png'),tier:"Bronze",desc:"Log 50 outdoor experiences.",unlocked:false},
    {title:"Finding Nature",progressQTY:100,imgPath:require('./IconBin/TrophyPNG/star9.png'),tier:"Silver",desc:"Log 200 outdoor experiences.",unlocked:false},
    {title:"One with Nature",progressQTY:500,imgPath:require('./IconBin/TrophyPNG/star10.png'),tier:"Gold",desc:"Log 1,000 outdoor experiences",unlocked:false},
    {title:"Butcher & Shepherd",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/shield3.png'),tier:"Silver",desc:"Construct & Log your own animal livestock collection.",unlocked:false},
    {title:"Of The Earth",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/shield4.png'),tier:"Bronze",desc:"Cultivate & Log a vegetable garden of at least 4 species.",unlocked:false},
    {title:"Nature's Friend",progressQTY:25, imgPath:require('./IconBin/TrophyPNG/person2.png'), tier:"Bronze", desc:"Plant & Log 100 unique trees of any shape or size.", unlocked:false},
    {title:"Nature's Steward",progressQTY:100, imgPath:require('./IconBin/TrophyPNG/person3.png'), tier:"Silver", desc:"Volunteer & Log 25 different community cleanups.", unlocked:false},
    {title:"Off The Grid",progressQTY:1,imgPath:require('./IconBin/TrophyPNG/star9.png'),tier:"Silver",desc:"Construct & Log a functioning rainwater collection system.",unlocked:false},
