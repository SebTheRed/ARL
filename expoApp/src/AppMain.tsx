...
function AppMain(): JSX.Element {
  ...
  const [XPTriggerEvents,setXPTriggerEvents] = useState({
    family:{
      ...
      family_photo: {type:"camera",title:"Take a Family Photo",desc:"Take a picture with you & 2 other family members.",xp: 10, unlocksAt: 2, perDay: 1, perWeek: 0, perMonth: 0,lockedBy:""},
      send_letter: {type:"camera",title:"Send a Letter",desc:"Send a letter to anyone! Receiving a letter must mean that they're family!", xp: 5, unlocksAt: 3, perDay:1, perWeek:0, perMonth:0,lockedBy:""},
      ...
      cook_family_dinner: {type:"camera", title:"Cook a Family Dinner", desc:"Prepare a meal and enjoy it with your family.", xp: 10, unlocksAt: 5, perDay: 1, perWeek: 0, perMonth: 0, lockedBy: ""},
      ...
      family_movie_night: {type:"camera", title:"Family Movie Night", desc:"Watch a movie with your family.", xp: 15, unlocksAt: 15, perDay: 1, perWeek: 0, perMonth: 0, lockedBy: ""},
    ...
    friends: {
      ...
      picture_with_friend: {type:"camera",title:"Take a Photo with a Friend.",desc:"Say cheese!", xp: 5, unlocksAt: 2, perDay: 1, perWeek:0, perMonth: 0,lockedBy:""},
      coffee_shop: {type:"camera",title:"Java Love",desc:"Spend time at any coffee shop, and take a picture of your order.", xp: 10, unlocksAt: 3, perDay:1, perWeek:0, perMonth:0,lockedBy:""},
      gaming_lounge: {type:"camera",title:"Gaming Lounge",desc:"Have a game night with at least 3 other friends. Irl or Virtual.", xp: 10, unlocksAt: 5, perDay:1, perWeek:0, perMonth:0,lockedBy:""},
      attend_club_meeting: {type:"camera",title:"Private Club",desc:"Check in at your club's meeting. Irl or Virtual.", xp: 25, unlocksAt: 5, perDay:0, perWeek:1, perMonth:0,lockedBy:""},
      date_night: {type:"timeline",title:"Date Night",desc:"Take your significant other out for a night on the town.", xp: 15, unlocksAt: 10, perDay:0, perWeek:1, perMonth:0,lockedBy:""},
      ...
      book_swap: {type:"timeline",title:"Book Swap",desc:"Trade a book you've already read with a friend doing the same.",xp: 100, unlocksAt: 30, perDay: 0, perWeek: 0, perMonth: 1,lockedBy:""},
    ...
    fitness: {
      ...
      walking: {type:"camera",title:"Go for a Walk",desc:"Go for a walk. Be sure to press start when you begin or it won't count!", xp: 20, unlocksAt: 0, perDay:2, perWeek:0, perMonth:0,lockedBy:""},
      daily_pushups: {type:"log",title:"Daily Pushups",desc:"Perform a slowly incrementing number of pushups every day.", xp: 10, unlocksAt: 2, perDay:1, perWeek:0, perMonth:0,lockedBy:""},
      cycling: {type:"camera",title:"Ride Your Bike!",desc:"Ride it here, ride it there, ride it anywhere!", xp: 10, unlocksAt: 3, perDay:1, perWeek:0, perMonth:0,lockedBy:""},
      swimming: {type:"camera",title:"Amphibious Exercises",desc:"Any workout in the water counts for this experience.", xp: 10, unlocksAt: 4, perDay:1, perWeek:0, perMonth:0,lockedBy:""},
      attend_gym: {type:"camera",title:"Go to the Gym",desc:"Spend time at any gym. Use this as motivation.", xp: 10, unlocksAt: 5, perDay:2, perWeek:0, perMonth:0,lockedBy:""},
      running: {type:"camera",title:"Runner's High",desc:"Go for a run. Be sure to press start when you begin!", xp: 20, unlocksAt: 10, perDay:2, perWeek:0, perMonth:0,lockedBy:""},
      ...
      run_5k: {type:"camera",title:"Five Kilometers",desc:"Run 3.2 miles. Be sure to press start when you begin!", xp: 50, unlocksAt: 40, perDay:0, perWeek:1, perMonth:0,lockedBy:""},
      ...
      class_instructor: {type:"camera",title:"Class In Session",desc:"Lead a class of at least 8 students in an exercise of any kind.",xp: 50, unlocksAt: 50, perDay: 1, perWeek: 0, perMonth: 0,lockedBy:""}
    },
    earthcraft: {
      recycle: {type:"camera",title:"Reduce Reuse Recycle",desc:"Do your part! Show off when you deposit a collection of recyclables.", xp: 20, unlocksAt: 0, perDay:0, perWeek:1, perMonth:0,lockedBy:""},
      ...
      natures_lens: {type:"camera",title:"Nature's Lens",desc:"Capture a breath-taking photograph of nature.", xp: 5, unlocksAt: 0, perDay:1, perWeek:0, perMonth:0,lockedBy:""},
      farmers_market: {type:"camera",title:"Fresh Food",desc:"Purchase food from a farmer, or farmer's market, directly.", xp: 10, unlocksAt: 2, perDay:1, perWeek:0, perMonth:0,lockedBy:""},      nature_hike: {type:"camera",title:"The Great Outdoors",desc:"Hike/Bike/Climb/Be in any area considered nature.", xp: 10, unlocksAt: 0, perDay:1, perWeek:0, perMonth:0,lockedBy:""},
      water_garden: {type:"log",title:"Water your Plants",desc:"Log that you watered your plants. Treat this as a reminder to do so!", xp: 5, unlocksAt: 3, perDay:1, perWeek:0, perMonth:0,lockedBy:""},
      bird_watch: {type:"camera",title:"Bird Watching",desc:"Snap a picture of a bird that you can see and identify it.",xp: 5, unlocksAt: 5, perDay: 2, perWeek: 0, perMonth: 0,lockedBy:""},
      new_plant: {type:"camera",title:"New House Plant",desc:"Acquire a new house plant.", xp: 10, unlocksAt: 10, perDay:0, perWeek:1, perMonth:0,lockedBy:""},
      upcycle: {type:"timeline",title:"Upcycle a Recyclable",desc:"Instead of disposing of something, re-purpose it in your home.", xp: 50, unlocksAt: 15, perDay:0, perWeek:1, perMonth:0,lockedBy:""},
    ...
    cooking: {
      make_meal: {type:"camera",title:"Cook a Meal",desc:"Cook a meal & label what it is. Snacks do not count.", xp: 5, unlocksAt: 0, perDay: 3, perWeek: 0, perMonth:0 ,lockedBy:""},
      bake: {type:"camera",title:"Bake Something",desc:"Bake anything & label what it is.", xp: 5, unlocksAt: 2, perDay: 2, perWeek: 0, perMonth:0 ,lockedBy:""},
      meal_prep: {type:"camera",title:"Meal Prep",desc:"Preparep meals for the upcoming week.", xp: 10, unlocksAt: 3, perDay: 0, perWeek: 1, perMonth:0 ,lockedBy:""},
      picnic: {type:"camera",title:"Have a Picnic",desc:"Take time to enjoy your meal outdoors.", xp: 5, unlocksAt: 5, perDay:1,perWeek:0,perMonth:0,lockedBy:""},
      upload_recipe: {type:"camera",title:"Family Recipe",desc:"Document a unique recipe to share with others.", xp: 10, unlocksAt: 10, perDay: 1, perWeek: 0, perMonth:0 ,lockedBy:""},
      love_thy_neighbor: {type:"camera",title:"Love Thy Neighbor",desc:"Cook or Bake food and give it to your neighbors. Save a little for yourself.", xp: 100, unlocksAt: 15, perDay: 0, perWeek: 0, perMonth:1 ,lockedBy:""},
      try_something_new:{type:"camera",title:"Changing Tastebuds",desc:"Try any food you have never tasted before.",xp:15,unlocksAt:20,perDay:1,perWeek:0,perMonth:0},
      love_language:{type:"camera",title:"Universal Love Language",desc:"Prepare a meal for someone else.",xp:10,unlocksAt:25,perDay:2,perWeek:0,perMonth:0},
      ...
      holiday_feast: {type:"timeline",title:"Holiday Feast",desc:"Document the cooking process of a holiday meal for you and others. Recipes encouraged!", xp: 150, unlocksAt: 40, perDay: 0, perWeek: 0, perMonth:1 ,lockedBy:""},
    ...
    technology: {
      ...
      retro_tech: {type:"camera",title:"Retro Tech",desc:"Share a retro piece of technology you own or stumble across.", xp: 10, unlocksAt: 0, perDay: 1, perWeek: 0, perMonth:0 },
      ...
      build_3d_model: {type:"camera",title:"3D Model",desc:"Show off a 3D model you made.",xp : 5, unlocksAt: 2, perDay: 2, perWeek: 0, perMonth: 0},
      drone: {type:"camera",title:"Drone Pilot",desc:"Pilot one or many drones.",xp : 20, unlocksAt: 3, perDay: 1, perWeek: 0, perMonth: 0},
      commit_open_src: {type:"api",title:"Open Source",desc:"Commit code to a public github repository.", xp: 5, unlocksAt: 5, perDay: 10, perWeek: 0, perMonth:0 },
      ...
      tech_tutorial: {type:"camera", title:"Tech Tutorial", desc:"Create a tech tutorial and upload to Youtube.", xp: 50, unlocksAt: 15, perDay: 0, perWeek: 1, perMonth: 0},
      raspberry_pi: {type:"camera", title:"Raspberry Pi", desc:"Create/Add To/Modify a Raspberry Pi Project", xp: 25, unlocksAt: 16, perDay: 0, perWeek: 1, perMonth: 0},
      ...
      threeD_model_animation: {type:"camera",title:"3D Animation",desc:"Animate a 3D model that you created.",xp : 20, unlocksAt: 25, perDay: 1, perWeek: 0, perMonth: 0},
      robotics_project: {type:"timeline", title:"Arigato Mr Roboto", desc:"Build  and/or program a robot. Teams encouraged.", xp: 150, unlocksAt: 30, perDay: 0, perWeek: 0, perMonth: 1},
      ...
      full_stack_app: {type:"timeline",title:"Full Stack App",desc:"Create and deploy a full stack application. HTTPS or App Store proof required.",xp : 200, unlocksAt: 50, perDay: 0, perWeek: 0, perMonth: 1},
    },
    games: {
      ...
      live_event: {type:"timeline",title:"Live Sports Event",desc:"Attend a sporting competition in real life. Must take picture of crowd.", xp: 100, unlocksAt: 10, perDay: 0, perWeek: 0, perMonth:1 ,lockedBy:""},
      sports_match: {type:"timeline",title:"Sporting Match",desc:"Compete in anything that can be considered a physical sport.", xp: 30, unlocksAt: 10, perDay: 0, perWeek: 1, perMonth:0 ,lockedBy:""},
      fishing_trip: {type:"camera",title:"Fishing Trip",desc:"Even when you don't catch a thing, you can share your trip here.", xp: 10, unlocksAt: 15, perDay: 1, perWeek: 0, perMonth:0 ,lockedBy:""},
      ...
      gotta_go_fast: {type:"api",title:"Got to Go Fast",desc:"Complete a speed-run of any game.", xp: 3, unlocksAt: 40, perDay: 10, perWeek: 0, perMonth:0 ,lockedBy:""},
    ...
    humanity: {
      ...
      meditation: {type:"log",title:"Meditation | Prayer",desc:"Sit still and listen.. Focus on breathing or communing with the Divine.",xp: 5, unlocksAt: 0, perDay: 3, perWeek: 0, perMonth: 0,lockedBy:""},
      ...
      donation: {type:"camera",title:"Second Handed",desc:"Donate clothing/homegoods/foodstuffs to any charitable organization.",xp: 50, unlocksAt: 2, perDay: 0, perWeek: 0, perMonth: 1,lockedBy:""},
      volunteer_event: {type:"camera",title:"Volunteering",desc:"Get out and give back to your community.", xp: 30, unlocksAt: 5, perDay: 0, perWeek: 1, perMonth:0 },
      ...
      blood_drive: {type:"camera",title:"Blood Drive",desc:"Give blood to a blood bank. Be sure to eat & stay hydrated!",xp: 50, unlocksAt: 15, perDay: 0, perWeek: 0, perMonth: 1,lockedBy:""},
      ...
      attend_art_show: {type:"timeline",title:"Art Show",desc:"Attend an art show, and see if any art is worth your dollar.", xp: 50, unlocksAt: 25, perDay: 0, perWeek: 1, perMonth:0 ,lockedBy:""},
      attend_church:{type:"camera",title:"Holy Day",desc:"Attend any religious gathering.",xp: 50, unlocksAt: 30, perDay: 0, perWeek: 1, perMonth: 0},
      maestro: {type:"timeline",title:"Artistic Instructor",desc:"Lead a class of at least 8 students in any form of artistic instruction.", xp: 100, unlocksAt: 40, perDay: 0, perWeek: 0, perMonth:1 ,lockedBy:""},
