    ...
    const [XPScale, setXPScale] = useState({
      ...
      const [XPTriggerEvents,setXPTriggerEvents] = useState({
        ...
        fitness: {
          ...
          marathon:{type:"timeline",title:"Triathalon",desc:"Compete in and complete a triathalon of any kind. Conquer all the faculties of fitness!",xp:500,unlocksAt:45,lockedBy:"",cooldown:730},
        ...
        earthcraft: {
          ...
          wildlife_park: {type:"timeline",title:"Natural Parks",desc:"Spend time in any of this great nation's National Parks.", xp: 100, unlocksAt: 50,lockedBy:"",cooldown:48}
        },
        cooking: {
          ...
          meal_prep: {type:"camera",title:"Meal Prep",desc:"Preparep meals for the upcoming week.", xp: 10, unlocksAt: 4,lockedBy:"",cooldown:168},
        ...
        technology: {
          ...
          tech_documentary:{type:"camera",title:"Technology Documentary",desc:"Watch and share your thoughts on a documentary about technology of any kind.",xp:5,unlocksAt:12,lockedBy:"",cooldown:24},
        ...
        games: {
          ...
          gotta_go_fast: {type:"timeline",title:"Got to Go Fast",desc:"Complete a speed-run of any video game.", xp: 100, unlocksAt: 40, lockedBy:"",cooldown:168},
