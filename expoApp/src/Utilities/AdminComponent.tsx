    ...
    const [XPScale, setXPScale] = useState({
      ...
      const [XPTriggerEvents,setXPTriggerEvents] = useState({
        family:{
          ...
          ancestral_home:{type:"timeline",title:"Ancestral Roots",desc:"Explore and share a place where your ancestors once lived.",xp:25,unlocksAt:4,lockedBy:"",cooldown:168},
          ...
          elder_learning:{type:"timeline",title:"Wisdom of Elders", desc:"Spend a day learning a traditional skill from one of your elders. E.g. Woodworking, Knitting, etc.",xp:35,unlocksAt:7,lockedBy:"",cooldown:168},
          ...
          help_with_chores: {type:"camera",title:"Chore Time",desc:"Help a family member with one of their chores.", xp: 15, unlocksAt: 12,lockedBy:"",cooldown:72},
          family_movie_night: {type:"camera", title:"Family Movie Night", desc:"Watch a movie with your family.", xp: 15, unlocksAt: 17,lockedBy: "",cooldown:168},
          ...
          family_tradition:{type:"timeline",title:"Family Traditions",desc:"Help organize & partake in something you and your family would consider tradition.", xp:100,unlocksAt:25,lockedBy:"",cooldown:730},
          ...
          family_heirloom:{type:"timeline",title:"Family Heirloom",desc:"Document the story behind a family heirloom. When you're done, pass it down to the next generation.",xp:175,unlocksAt:35,lockedBy:"",cooldown:730},
        ...
        friends: {
          ...
          potluck:{type:"timeline",title:"Potluck Dinner",desc:"Organize or attend a potluck with your friends, where everyone brings a dish.",xp:50,unlocksAt:7,lockedBy:"",cooldown:730},
          ...
          restaurant_bar: {type:"camera",title:"Out on the Town",desc:"Spend time at any restaurant / bar / brewery.", xp: 15, unlocksAt: 12,lockedBy:"",cooldown:72},
          watch_party:{type:"camera",title:"Watch Party",desc:"Host an IRL or virtual watch party for a TV series finale, or big TV event.",xp:25,unlocksAt:15,lockedBy:"",cooldown:168},
          festival_friends:{type:"timeline",title:"Festival of Friends",desc:"With friends, get out and experience a cultural or food festival in town!",xp:35,unlocksAt:17,lockedBy:"",cooldown:168},
          ...
          attend_private_party: {type:"timeline",title:"Private Party",desc:"Have a themed party of at least 4 friends.",xp: 40, unlocksAt: 25,lockedBy:"",cooldown:730},
          ...
          class_together:{type:"timeline",title:"Class of Clans",desc:"Whether it's pottery, painting, or a new language, attend an IRL or virtual class with a friend.",xp:50,unlocksAt:35,lockedBy:"",cooldown:168},
        ...
        fitness: {
          ...
          daily_aerobics:{type:"log",title:"Daily Aerobics",desc:"Get your blood pumping! Log about jumping rope, jumping jacks, or even dancing!",xp:10,unlocksAt:0,lockedBy:"",cooldown:24},
          daily_pushups: {type:"log",title:"Daily Pushups",desc:"Perform your daily pushups. Incrementing day by day encouraged!", xp: 10, unlocksAt: 2,lockedBy:"",cooldown:24},
          ...
          yoga: {type:"camera",title:"Namaste, Yogi",desc:"Complete a yoga exercise, whether it be at home or at the studio.", xp: 15, unlocksAt: 15,lockedBy:"",cooldown:24},
          snowy_fitness:{type:"camera",title:"Icy Veins", desc:"Hit the slopes to ski or snowboard, doing tricks is encouraged!", xp:20,unlocksAt:18,lockedBy:"",cooldown:24},
          ...
          obstacle_race:{type:"timeline",title:"No Easy Feat", desc:"Complete a race that involves obstacles. E.g. Mud runs, Spartan races, etc.",xp:100,unlocksAt:25,lockedBy:"",cooldown:730},
          achieve_pr: {type:"timeline",title:"Personal Record",desc:"Accomplish & document a person record of any category.", xp: 150, unlocksAt: 30, lockedBy:"",cooldown:730},
          run_5k: {type:"camera",title:"Five Kilometers",desc:"Run 3.2 miles. Alone or in a 5k!", xp: 50, unlocksAt: 40,lockedBy:"",cooldown:730},
          belt_rank: {type:"timeline",title:"Martial Master",desc:"Ascend in belt rank at an official martial arts academy.", xp: 250, unlocksAt: 40,lockedBy:"",cooldown:730},
          marathon:{type:"timeline",title:"Triathalon",desc: "Compete in and complete a triathlon of any kind. Conquer all the facets of fitness!" ,xp:500,unlocksAt:45,lockedBy:"",cooldown:730},
        ...
        earthcraft: {
          ...
          eco_home:{type:"camera",title:"Eco-Product",desc:"Switch to or showcase an eco-friendly household product.", xp:10,unlocksAt:7,lockedBy:"",cooldown:168},
          new_plant: {type:"camera",title:"New House Plant",desc:"Acquire a new house plant.", xp: 10, unlocksAt: 10,lockedBy:"",cooldown:168},
          home_garden:{type:"camera",title:"Home Garden",desc:"Take a picture of your home garden. It's that easy!",xp:15,unlocksAt:10,lockedBy:"",cooldown:168},
          zero_waste:{type:"timeline",title:"Zero-Waste Day",desc:"Spend a day producing NO trash. Share your zero-waste techniques when you've finished!",xp:20,unlocksAt:12,lockedBy:"",cooldown:168},
          upcycle: {type:"timeline",title:"Upcycle a Recyclable",desc:"Instead of disposing of something, re-purpose it in your home.", xp: 25, unlocksAt: 17,lockedBy:"",cooldown:168},
          ...
          solar_switch:{type:"timeline",title:"Solar Switch",desc:"Document your home's switch to solar energy. Renewables are the future!",xp:100,unlocksAt:25,lockedBy:"",cooldown:730},
          ...
          animal_sanctuary:{type:"timeline",title:"Animal Sanctuary",desc:"Spend time at an animal sanctuary and learn about wildlife conservation.",xp:200,unlocksAt:45,lockedBy:"",cooldown:730},
          wildlife_park: {type:"timeline",title:"National Parks",desc:"Spend time in any of this great nation's National Parks.", xp: 100, unlocksAt: 50,lockedBy:"",cooldown:48}
        },
        cooking: {
          ...
          bake: {type:"camera",title:"Bake Something",desc:"Bake anything & label what it is.", xp: 5, unlocksAt: 0,lockedBy:"",cooldown:12},
          grill_master:{type:"camera",title:"Grill Master",desc:"Cook an entire meal using only a grill.",xp:5,unlocksAt:2,lockedBy:"",cooldown:24},
          bread_baker:{type:"timeline",title:"Boulanger", desc:"Bake your own bread from scratch. Share your process for others to learn!",xp:10,unlocksAt:3,lockedBy:"",cooldown:72},
          meal_prep: {type:"camera",title:"Meal Prep",desc:"Prepare meals for the upcoming week.", xp: 10, unlocksAt: 4,lockedBy:"",cooldown:168},
          picnic: {type:"camera",title:"Have a Picnic",desc:"Take time to enjoy your meal outdoors.", xp: 5, unlocksAt: 5,lockedBy:"",cooldown:24},
          international_cuisine:{type:"camera",title:"International Cuisine",desc:"Cook a meal from a country/culture you've never cooked from before.",xp:10,unlocksAt:7,lockedBy:"",cooldown:168},
          ...
          farm_to_table:{type:"timeline",title:"Farm to Table",desc:"Make a meal using only locally sourced ingredients. One picture must include the vendor you bought from!",xp:25,unlocksAt:12,lockedBy:"",cooldown:72},
          fermentation:{type:"timeline",title:"Fermentation Station",desc:"Ferment something - could be sauerkraut, kombucha, kimchi, etc. Then share your process!",xp:50,unlocksAt:15,lockedBy:"",cooldown:168},
          love_thy_neighbor: {type:"camera",title:"Love Thy Neighbor",desc:"Cook or Bake food and give it to your neighbors. Save a little for yourself.", xp: 100, unlocksAt: 17,lockedBy:"",cooldown:168},
          ...
          whole_foods:{type:"camera",title:"Age with Grace",desc:"Make a meal using only whole, unprocessed ingredients. This is the key to a long life.",xp:15,unlocksAt:35,lockedBy:"",cooldown:4},
          ...
          preservation:{type:"camera",title:"Food Preservation",desc:"Can, freeze, or dehydrate food for future use.",xp:25,unlocksAt:45,lockedBy:"",cooldown:24},
        ...
        technology: {
          ...
          drone: {type:"camera",title:"Drone Pilot",desc:"Pilot one or many drones.",xp : 20, unlocksAt: 3, lockedBy:"",cooldown:24},
          ...
          smart_home:{type:"timeline",title:"Smart Home Integration",desc:"Share your newly installed piece of smart-home technology.",xp:25,unlocksAt:7,lockedBy:"",cooldown:168},
          ...
          tech_documentary:{type:"camera",title:"Technology Documentary",desc:"Watch a documentary about any kind of technology and share your thoughts.",xp:5,unlocksAt:12,lockedBy:"",cooldown:24},
          ...
          raspberry_pi: {type:"camera", title:"Raspberry Pi", desc:"Create/Add To/Modify a Raspberry Pi Project", xp: 25, unlocksAt: 17, lockedBy:"",cooldown:72},
          build_app: {type:"timeline",title:"Computer Application",desc:"Develop a basic computer application in any programming language.", xp: 50, unlocksAt: 20, lockedBy:"",cooldown:72},
          ...
          tech_expert:{type:"timeline",title:"Tech Expert", desc:"Repair a piece of technology instead of replacing it.",xp:180,unlocksAt:35,lockedBy:"",cooldown:168},
        ...
        games: {
          ...
          party_games:{type:"camera",title:"Party Games",desc:"Play a social party game, like charades, pictionary, or even Mario Party!",xp:10,unlocksAt:3,lockedBy:"",cooldown:24},
          game_merch:{type:"camera",title:"Gaming/Sporting Merch",desc:"Share a piece of merchandise you own. E.g. a jersey, miniature, or even a signed ball!",xp:15,unlocksAt:4,lockedBy:"",cooldown:72},
          ...
          trivia_night: {type:"camera",title:"Trivia Einsteins",desc:"Participate in a trivia contest.", xp: 25, unlocksAt: 7, lockedBy:"",cooldown:168},
          ...
          sports_match: {type:"timeline",title:"Sporting Match",desc:"Compete in anything that can be considered a physical sport.", xp: 30, unlocksAt: 12, lockedBy:"",cooldown:168},
          ...
          escape_room:{type:"timeline",title:"Escape Room",desc:"Successfully complete an IRL escape room challenge. Bring some friends, you'll need them!",xp:50,unlocksAt:17,lockedBy:"",cooldown:730},
          ...
          sport_achievement: {type:"timeline",title:"Sporting Achievement",desc:"Share your trophy/medal that you earned in a sporting contest of any kind.", xp: 100, unlocksAt: 22, lockedBy:"",cooldown:168},
          stream_time: {type:"camera",title:"Stream Time",desc:"Stream yourself gaming! Make the post before you begin to invite others!", xp: 25, unlocksAt: 25, lockedBy:"",cooldown:24},
          sports_sim:{type:"timeline",title:"Half & Half",desc:"Play a match in any sports simulation game. Half sport, half video game!", xp:50,unlocksAt:27,lockedBy:"",cooldown:168},
          ...
          mmo_raid:{type:"camera",title:"Leeeeeroyyyy!",desc:"Successfully complete a major raid or dungeon in an MMO with your guild/team. Show off your loot!",xp:15,unlocksAt:35,lockedBy:"",cooldown:24},
          gotta_go_fast: {type:"timeline",title:"Gotta Go Fast",desc:"Complete a speed-run of any video game.", xp: 100, unlocksAt: 40, lockedBy:"",cooldown:168},
        ...
        language: {
          ...
          poem:{type:"log",title:"Wordsmith", desc:"Write a short poem, and share it with ARL.",xp:10,unlocksAt:7,lockedBy:"",cooldown:24},
          ...
          idiom:{type:"log",title:"Idiomatic", desc:"Share an idiom or some words of wisdom with ARL.", xp:5,unlocksAt:12,lockedBy:"",cooldown:24},
          tutor: {type:"camera",title:"Language Mentorship",desc:"Spend a decent amount of time helping someone learn their non-native language.", xp: 10, unlocksAt: 15, lockedBy:"",cooldown:72},
          lecture_circuit:{type:"timeline",title:"Attend a Lecture",desc:"Attend a lecture or talk. Enter with an open mind, you will be surprised what you gain.", xp:50,unlocksAt:17,lockedBy:"",cooldown:168},
          ...
          public_speaking: {type:"timeline",title:"Honored Speaker",desc:"Speak publicly before a crowd.", xp: 150, unlocksAt: 25, lockedBy:"",cooldown:168},
          ...
          author:{type:"timeline",title:"Author a Book",desc:"Write, review, and publish a book! Share your awesome accomplishment here.",xp:150,unlocksAt:35,lockedBy:"",cooldown:730},
          ...
          record_speaking_language: {type:"timeline",title:"Tower of Babel",desc:"Upload some videos of your foreign language skills for the world to hear!", xp: 50, unlocksAt: 50, lockedBy:"",cooldown:72},
        },
        humanity: {
          ...
          meditation: {type:"log",title:"Meditation | Prayer",desc:"Sit still and listen.. Focus on breathing or communing with the Divine.",xp: 5, unlocksAt: 0, lockedBy:"",cooldown:4},
          ...
          pet_time:{type:"camera",title:"Human's Best Friend",desc:"Spend time with your pet. To you, they're only a part of your life. To them, you are everything!",xp:10,unlocksAt:0,cooldown:24},
          donation: {type:"camera",title:"Second Handed",desc:"Donate clothing, homegoods, or foodstuffs to any charitable organization.",xp: 50, unlocksAt: 2, lockedBy:"",cooldown:168},
          ...
          first_amendment:{type:"timeline",title:"1st Amendment", desc:"Gather with a group of like-minded individuals and march for a cause you all believe in.",xp:100,unlocksAt:7,lockedBy:"",cooldown:730},
          ...
          tutor:{type:"camera",title:"From one Mind to Another",desc:"Share a skill or talent with someone who is eager to learn from you.", xp:20,unlocksAt:12,lockedBy:"",cooldown:72},
          ...
          historic_site:{type:"timeline",title:"History Happened Here",desc:"Travel to a historic location. Be sure to absorb the history and significance of the place.",xp:50,unlocksAt:17,lockedBy:"",cooldown:168},
          visit_museum: {type:"timeline",title:"Museum Day",desc:"Visit a museum of any kind.", xp: 40, unlocksAt: 20, lockedBy:"",cooldown:168 },
          thrift:{type:"camera",title:"Thoroughly Thrify", desc:"Share what you buy second-hand. Help reduce the carbon-footprint of consumerism.",xp:25, unlocksAt:22,lockedBy:"",cooldown:24},
          ...
          organize_charity: {type:"timeline",title:"Organize Charity Work",desc:"Organize and accomplish charity work with 4+ people including yourself.", xp: 100, unlocksAt: 45,lockedBy:"",cooldown:730},
